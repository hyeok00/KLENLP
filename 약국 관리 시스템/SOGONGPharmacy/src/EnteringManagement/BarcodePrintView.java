...
public class BarcodePrintView extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BarcodePrintView frame = new BarcodePrintView();
	...
	public BarcodePrintView() {
		...
		JLabel lblNewLabel = new JLabel("바코드 출력");
...
//				int enteringQuantity = Integer.parseInt(stringEnteringQuantity);
				...
				JOptionPane.showMessageDialog(null, "프린터에 바코드 출력 요청을 보냈습니다.");
