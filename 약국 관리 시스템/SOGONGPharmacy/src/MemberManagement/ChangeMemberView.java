...
public class ChangeMemberView extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ChangeMemberView frame = new ChangeMemberView();
	...
	public ChangeMemberView() {
		...
		txt_changePhone.setBounds(409, 271, 181, 29);
		...
		btn_change.setBounds(665, 224, 90, 29);
		...
		btn_cancel.setBounds(621, 271, 134, 30);
