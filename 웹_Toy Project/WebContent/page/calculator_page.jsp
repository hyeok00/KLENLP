...
<head>
    ...
    <link rel="stylesheet" href="/Web_Project/recesources/css/calculator.css">
</head>
...
<body>
    <div class="wrap">
        ...
        <div class="container">
            <div class="section">
                 <iframe src="http://salary.fpvhxm.com/" frameborder="0" width="940" height="830" scrolling="yes"></iframe>
            </div>
